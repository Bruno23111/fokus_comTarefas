...
const paragrafroDescricaoTarefa = document.querySelector('.app__section-active-task-description')
...
const excluirTarefaDoForm = document.querySelector('.app__form-footer__button--delete')
...
function adicionarTarefa(tarefa) {
    ...
    botao.onclick = () => {
        ...
        if (novaDescricao && novaDescricao != null) {
            paragrafro.textContent = novaDescricao
    ...
    if (tarefa.completa) {
        ...
        li.onclick = () => {
            ...
            if (tarefaSelecionada==tarefa) {
                paragrafroDescricaoTarefa.textContent = ''
            ...
            paragrafroDescricaoTarefa.textContent = tarefa.descricao
...
excluirTarefaDoForm.addEventListener('click', () => {
    textArea.value = ''
})
